...
interface GroupParticipantsAddTabProps {
  sessionId: string
}

export function GroupParticipantsAddTab({ sessionId }: GroupParticipantsAddTabProps) {
      ...
      <div className="rounded-xl border bg-card p-6 shadow-sm">
         <div className="grid gap-4">
            ...
            <div className="grid gap-2">
                ...
                <Button size="sm" onClick={() => addMutation.mutate()} disabled={!groupId || !participants || addMutation.isPending}>
