...
interface GroupSettingsMessagesTabProps {
  sessionId: string
}

export function GroupSettingsMessagesTab({ sessionId }: GroupSettingsMessagesTabProps) {
      ...
      <div className="rounded-xl border bg-card p-6 shadow-sm">
         <div className="grid gap-6">
            ...
            <div className="grid gap-4 border p-4 rounded-lg">
                <h4 className="font-medium text-sm">Message Settings</h4>
